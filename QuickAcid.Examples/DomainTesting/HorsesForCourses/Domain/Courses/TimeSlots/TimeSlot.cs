using QuickAcid.Examples.DomainTesting.HorsesForCourses.Domain.Courses.InvalidationReasons;

namespace QuickAcid.Examples.DomainTesting.HorsesForCourses.Domain.Courses.TimeSlots;
